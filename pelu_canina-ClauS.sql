...
/*EJERCICIO NUMERO 7*/
Select Monto from Historial where fecha >= '2022/07/01' 
and fecha <= '2022/07/31

/*EJERCICIO NUMERO 8 */
insert into perro (ID_Perro,Nombre,Fecha_nac,Sexo,Dni_Dueno,) values (10,´negri´,'2015-12-15´,´femenino´, 99223333);
